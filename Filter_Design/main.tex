...
\author{Avani Chouhan\\EE23BTECH11205}
\date{}
...
\item {The Low Pass Chebyschev Filter Paramters:} The magnitude squared of the Chebyschev low pass filter is given by 
\begin{align}
...
\begin{align}
    c_N(x) &= \cosh(N \cosh^{-1}x) , x=\Omega_{L}\text{(i.e. greater than 1 here)}\\
    c_0(x) &= 1 \\
    c_1(x) &= x
\end{align}
...
\begin{align}
    \vert H_{a,LP}(j\Omega_L)\vert < \delta_{2} \hspace{5pt} \text{for}\hspace{5pt} \Omega_L = \Omega_{Ls}\\
    1-\delta_{1}<\vert H_{a,LP}(j\Omega_L)\vert < 1 \hspace{5pt} \text{for}\hspace{5pt} \Omega_L = \Omega_{Lp}
\end{align}
we obtain :
\begin{eqnarray}
\label{lpdesign}
...
\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/H_a_lp_diff_epsilons.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/H_a_lp.png}
...
\begin{align}
    ...
    \text{where } \hspace{10pt} c_N(x) = 8x^4 - 8x^2 + 1\quad(N = 4)\label{eq:pole_ques}
\end{align}
On solving \eqref{eq:pole_ques} using the below code we obtain poles.

\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/calc_poles.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/poles_plot.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/pole.png}
\caption{The Pole zero plot and all the poles lie on an ellipse. }
...
\end{align}
where $G_{LP}$ is the gain of the Low pass filter. Refer to \tabref{tab:values poles sk} for pole's values.\\
...
\end{align}
Substituting respective values in \eqref{eq:Gain_eq_LP}, using the below code, we get $G_{LP}=0.4166$

\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/G_lp.py
\end{lstlisting}
\begin{align}
     H_{a,LP}(s_L) &= \frac{0.4166}{\brak{s_L-s_1}\brak{s_L-s_2}\brak{s_L-s_3}\brak{s_L-s_8}}
\end{align}
Using the below code to simplify the polynomial, we get
\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/calc_polyno.py
\end{lstlisting}

\begin{align}
    H_{a,LP}(s_L) &= \frac{0.4166}{s_{L}^4 + 1.3022s_{L}^3 +1.84781s_{L}^2 + 1.16512s_{L} +0.435003}\label{eq:design}
\end{align}

The below code plots design v/s specification of our lowpass filter
\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/verifications.py
\end{lstlisting}

\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/veri.png}
...
\end{align}
Substituting \eqref{eq:res1} in \eqref{eq:res2} we obtain Gain of required bass pass filter using the below code:

\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/G_bp.py
\end{lstlisting}
...
\begin{align}
    G_{BP} &= 1.0370 
\end{align}
Thus the response in s domain (using substitutions, using the below code)

\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/H_in_s.py
\end{lstlisting}
...
match well with those obtained analytically through the bilinear transformation. This is done using the below code:

\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/H_a_bp.py
\end{lstlisting}

\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/H_a_bp.png}
...
\end{align}
Substituting $s=\frac{1-z^{-1}}{1+z^{-1}}$ in \eqref{eq:magnitude_bandpass_sdom} and calculating expression using the below python code we get :

\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/analog_to_digital.py
\end{lstlisting}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/ana_to_digi.png}
...
The below code plots this figure
\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/freq_resp_imp_resp_ideal.py
\end{lstlisting}


\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/freq_resp_imp_resp_ideal.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/fir_lp.png}
...
The below code plots this figure
\begin{lstlisting}
https://github.com/aditidure17/signals-and-system/blob/main/filter_design/codes/fir_bp.py
\end{lstlisting}

\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/fir_bp.png}
